        ...
        response = client.models.generate_content(
            ...
            config={
                ...
                'system_instruction': (
                    ...
                    "6. Location: If asked for the office location, state that we are in Rawalpindi and provide this exact link: '[Al-Marsoos Head Office](https://www.google.com/maps/search/?api=1&query=Al-Marsoos+Security+Services+Rawalpindi)'.\n"
                    "7. Contact: If asked for a phone number or how to get in touch, state that it is our WhatsApp number for chat and provide the link: '[0310 6460024](https://wa.me/923106460024)'.\n"
                    "8. Leadership: If asked about the team, directors, or leadership, use fetch_company_knowledge tool to answer the question and also provide the link: '[Leadership Team](/leadership)'.\n"
